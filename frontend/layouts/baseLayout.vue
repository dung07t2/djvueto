    ...
    <v-navigation-drawer temporary
      ...
      <v-list>
        <v-list-tile @click="changeSingleSetting('secondDrawerRight')">
          ...
          <v-list-tile-title>Move to {{ settings.secondDrawerRight ? 'left' : 'right' }}</v-list-tile-title>
        </v-list-tile>
      </v-list>
    </v-navigation-drawer>
...
export default {
  data: () => ({
    ...
    secondDrawer: false,
    allRoutes: [
      { to: { name: 'index' }, title: 'Home', icon: 'home', exact: true },
      { to: { name: 'users' }, title: 'Users', icon: 'people_outline', exact: true, permission: false },
      { to: { name: 'settings' }, title: 'Settings', icon: 'settings' },
      { to: { name: 'auth-login' }, title: 'Login', icon: 'fingerprint', permission: true },
      { to: { name: 'auth-registration' }, title: 'Registration', icon: 'person_add', permission: true },
      { to: { name: 'auth-logout' }, title: 'Logout', icon: 'power_settings_new', permission: false },
    ],
    userDropdownRoutes: [
      { to: { name: 'auth-user-edit' }, title: 'Edit', icon: 'edit' },
      { to: { name: 'auth-password-change' }, title: 'Change password', icon: 'security' },
    ]
  }),
  computed: {
