<template>
  <v-layout row
    ...
    <v-flex xs12
      ...
      <v-card>
        <v-toolbar>
          <v-toolbar-title>Total user {{ searchText && 'found' }}: {{ users.count }}</v-toolbar-title>
          <v-spacer></v-spacer>
        ...
        <v-list three-line>
          ...
          <template v-else>
            <v-subheader>Не found</v-subheader>
            <v-list-tile>
              <v-list-tile-content>
                <v-list-tile-title> Nothing found at your request </v-list-tile-title>
                 <v-list-tile-sub-title> Try changing the query </v-list-tile-sub-title>
              </v-list-tile-content>
            </v-list-tile>
          </template>
        </v-list>
